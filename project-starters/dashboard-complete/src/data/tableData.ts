...
/*
  tableData.ts — Mock order data for the DataTable component.

  50 orders spread across 2024 give enough data to demonstrate:
  - Pagination (10 rows per page = 5 pages)
  - Sorting (various data types: string, number, date)
  - Date range filtering (spread across all 12 months)
  - Status badge variety (all 4 statuses appear)
*/
